...
This project is for develope ETL framework in python and dockerization to aviod envinorment related restrictions
...
Most of the source codes of this project, `DatiumETL` are stored in the `repo_datium_etl` directory.
...
`make create-container` creates and launch the repo_datium_etl container.
