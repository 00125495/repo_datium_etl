...
class Project(Base):
    ...
    azure_devops_organization = Column(String(255))
    azure_devops_project = Column(String(255))
    azure_devops_area_path = Column(String(500))
    azure_devops_iteration_path = Column(String(500))
...
class UserStory(Base):
    ...
    azure_devops_work_item_type = Column(String(50))  # User Story, Task, Bug, Feature
    azure_devops_state = Column(String(50))  # New, Active, Resolved, Closed
    azure_devops_assigned_to = Column(String(255))
    azure_devops_url = Column(String(500))
    azure_devops_sync_status = Column(String(50), default="not_synced")  # not_synced, synced, sync_failed
    azure_devops_last_sync = Column(DateTime(timezone=True))
...
class AzureDevOpsIntegration(Base):
    __tablename__ = "azure_devops_integrations"
    ...
    personal_access_token = Column(String(255))  # Encrypted in production
    
    # Default settings
    default_work_item_type = Column(String(50), default="User Story")
    ...
    sync_status = Column(String(50), default="not_configured")
